...
%type1 = 1; type2 = 2;
%pos1 = [4.5;1.5;0]; pos2=[5.75;3.75;pi/4];
...
elseif abs(pos2(3)-pos1(3)) < 0.002
    ...
    notcollide1 = (abs((y2 - width_veh(type1)/2 - width_veh(type2)/2/cos(pos2(3)-pos1(3)))/tan(pos2(3)-pos1(3))) - (length_veh(type1)/2-x2) > 0.002);
    notcollide2 = (abs((y2 - width_veh(type1)/2 - width_veh(type2)/2/cos(pos2(3)-pos1(3)))/sin(pos2(3)-pos1(3))) -( length_veh(type2)/2 - width_veh(type2)/2*tan(pos2(3)-pos1(3))) > 0.002);
